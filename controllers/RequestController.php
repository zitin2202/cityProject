...
class RequestController extends Controller
{
     ...
     */
     ...
     function ImageLoad($model){
        ...
        $file_name="/images/" . \Yii::$app->getSecurity()->generateRandomString(50). '.' . $model->img->extension;
    ...
    public function actionCountSolvedRequests(){
        $solved_requests = Request::find()->where(["status"=>"Решена"])->count();
